 ...
 */
public class DynList extends ListView {
    ...
    public DynList(Context context) {
        super(context);
        init(context);
    }

    public DynList(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DynList(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(locations, originalItem, getPositionForView(switchView));
    ...
    public void setLocations(ArrayList<YelpLocation>locations){
